...
def main():
	...
	de = pd.DataFrame(columns=['gene','gRNA','allele','ks','mwu','ad'])
	...
	sig_filter_bool = de[sig_filter].any(axis='columns')	
	...
	kpe_filter['Fano'] = kpe_filter['var']/(kpe_filter['mean']*kpe_filter['mean'])
	kpe_filter['bursting'] = 0
	bursting = kpe_filter['Fano'] > (1 / kpe_filter['mean'])
	kpe_filter.loc[bursting,'bursting'] = 1
	select_11 = kpe_filter['bursting'] == 1
	kpe_df_bursting = kpe_filter[select_11]
